        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h3 className="text-black mb-4 text-2xl sm:text-3xl lg:text-4xl">
              Estas son las claves que nos diferencian...
            </h3>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Todas las soluciones - Un solo lugar.
            </p>
          </motion.div>
            ...
            {[
              {
                id: 'icon-engine',
                title: 'Rectificación',
                description: 'Planta Rectificadora',
              ...
              },
              {
                ...
                description: 'Servicio de mecánica completo',
              ...
              },
              {
                ...
                description: 'Cubrimos tus necesidades!',
